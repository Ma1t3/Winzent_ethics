# import pytest
#
# from tests.proof_of_concept.winzent.util_functions import create_agents, shutdown
#
#
# @pytest.mark.asyncio
...
#     # sure one message can be forwarded through the complete network
#     ttl = 19
#     agents, container = await create_agents(number_of_agents=number_of_agents, ttl=ttl, time_to_sleep=30)
#
#     for agent in agents:
#         agent.update_flexibility(t_start=0, min_p=0, max_p=10)
